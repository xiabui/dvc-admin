<template>
  <MainLayout :path="COMPONENT_NAMES.procedure">
    <Toast />
    <ConfirmDialog></ConfirmDialog>
    <MainNavbar :breadcrumbs="['Thủ tục']">
      <template #action>
        <FlatButton
          label="Tạo mới"
          ...
          icon="add"
          :icon-size="16"
          @click="navigate(COMPONENT_NAMES.newProcedure)"
        />
      </template>
    </MainNavbar>
    <div class="main-body">
      <div class="dvc-card">
        <TableHeader title="Thủ tục" :total-item="200">
          <template #action>
            <v-menu :width="300">
        ...
        <TableContainer
          :columns="PROCUDURE_MANAGEMENT_COLUMNS"
          :data="procedureData"
          :multipleSelect="true"
...
import { PROCUDURE_MANAGEMENT_COLUMNS } from "@/utils/table";
import { procedureData } from "@/utils/mockData";
